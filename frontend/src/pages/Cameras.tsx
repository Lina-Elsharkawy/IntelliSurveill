...
const Cameras = () => {
  ...
  const cameras = [
    ...
    { id: "cam-003", name: "Library Main", location: "Central Campus - Floor 2", status: "alert" as const, thumbnail: cameraFeed3 },
    { id: "cam-004", name: "Corridor 2B", location: "Building B - Floor 2", status: "active" as const, thumbnail: cameraFeed4 },
    { id: "cam-005", name: "Cafeteria North", location: "Student Center", status: "active" as const, thumbnail: cameraFeed1 },
    { id: "cam-006", name: "Sports Complex", location: "East Campus", status: "active" as const, thumbnail: cameraFeed2 },
    { id: "cam-007", name: "Lab 3A", location: "Science Building", status: "inactive" as const, thumbnail: cameraFeed3 },
    ...
    { id: "cam-010", name: "Dorm Entrance A", location: "Residence Hall A", status: "active" as const, thumbnail: cameraFeed1 },
