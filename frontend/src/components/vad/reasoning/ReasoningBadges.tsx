...
export function DecisionBadge({ decision }: { decision: string }) {
  ...
  if (d === "UNCERTAIN") return <Badge className="bg-blue-500/20 text-blue-400 border border-blue-500/30 hover:bg-blue-500/30 font-bold uppercase text-[10px]">UNCERTAIN</Badge>;
...
export function RatioBadge({ ratio }: { ratio: number }) {
  ...
  if (band === "moderate") return <Badge variant="outline" className="text-blue-400 border-blue-800 bg-blue-900/20 uppercase text-[10px]">Moderate Ratio</Badge>;
